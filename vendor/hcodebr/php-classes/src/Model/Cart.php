...
class Cart extends Model {
    ...
    public function save()
    {
        ...
        $vlrfreight = (float) $this->getvlfreight();
    ...
    public static function formatValueToDecimal($value):floatval
    {
